    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ragister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                compositeDisposable.add(myAPI.ragisterMser(email.getText().toString(),name.getText().toString(),username.getText().toString(),
                        password.getText().toString(),role.getText().toString(),mobile.getText().toString(),credit_ref.getText().toString(),
                        exposer_limit.getText().toString(),upline.getText().toString(),downline.getText().toString(),userName)
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Consumer<String>() {
                            @Override
                            public void accept(String s) throws Throwable {
                                Toast.makeText(Ragister_Master.this, name.getText().toString()+" As Master "+s, Toast.LENGTH_SHORT).show();
                            }
                        }));
            }
        });
