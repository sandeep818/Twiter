...
public class Master_home extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    TextView greetings;
    TextView username;
    ImageView bgimage;
        ...
        mynavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
               ...
               //        logout_user();
                       ...
                       editor.clear();
                        editor.apply();
                       Intent intent = new Intent(Master_home.this,Login.class);
    ...
    public void showPopup(){
        ...
        master_ragister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Master_home.this, Ragister_Master.class);
                startActivity(intent);
                dialog.dismiss();
        ...
        user_ragister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Master_home.this, Ragister_user.class);
                startActivity(intent);
                dialog.dismiss();
                //*****************animation when witch activity*********************
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
